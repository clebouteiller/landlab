...
class ExponentialWeatherer(Component):
    ...
    def run_one_step(self, dt=None, max_soil_production_rate_if_used=None, **kwds):
        """
        ...
        """
        if max_soil_production_rate_if_used is not None:
            self.w0 = max_soil_production_rate_if_used
